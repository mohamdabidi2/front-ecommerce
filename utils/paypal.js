 ...
 *
 */
module.exports= async function checkIfNewTransaction(orderModel, paypalTransactionId) {
  try {
 ...
 *
 */
module.exports= async function verifyPayPalPayment(paypalTransactionId) {
